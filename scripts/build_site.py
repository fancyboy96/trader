...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px">
  <span id="view-label" style="font-size:13px;color:var(--text-dim)">{len(all_passed)} companies &nbsp;·&nbsp; sorted by score</span>
  <div style="display:flex;align-items:center;gap:6px">
    <span style="font-size:11px;color:var(--text-dim);text-transform:uppercase;letter-spacing:.08em">View:</span>
    <button id="btn-score" onclick="setView('score')"
      style="font-size:12px;padding:5px 12px;border:1px solid var(--accent);border-radius:4px 0 0 4px;
